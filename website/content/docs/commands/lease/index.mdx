...
The `lease` command groups subcommands for interacting with leases attached to
secrets. For leases attached to tokens, use the [`bao token`](../token/index.mdx) subcommand.
...
```shell-session
$ bao lease revoke database/creds/readonly/27e1b9a1-27b8-83d9-9fe0-d99d786bdc83
