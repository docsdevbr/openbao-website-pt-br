...
- `-non-voter` `(bool: false)` - This flag is used to make the
  ...
  See [`retry_join_as_non_voter`](../../configuration/storage/raft.mdx#retry_join_as_non_voter)
  ...
  settings](../../configuration/storage/raft.mdx#raft-parameters) for your intended
  use case.
...
For a more detailed overview of autopilot features, see the [concepts page](../../concepts/integrated-storage/autopilot.mdx).
