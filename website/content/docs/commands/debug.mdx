...
description: |-
  The "debug" command monitors an OpenBao server, probing information about
  it for a certain duration.
---

# debug

The `debug` command starts a process that monitors an OpenBao server, probing
information about it for a certain duration.

Gathering information about the state of the OpenBao cluster often requires the
...
```shell-session
$ tree openbao-debug-2019-10-15T21-44-49Z/
