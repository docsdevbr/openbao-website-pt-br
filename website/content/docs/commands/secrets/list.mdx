...
sidebar_label: list
description: |-
  The "secrets list" command lists the enabled secrets engines on the OpenBao
...
The `secrets list` command lists the enabled secrets engines on the OpenBao server.
