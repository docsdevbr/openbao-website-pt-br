...
- Installation via [OpenBao Helm](../helm/index.mdx)
...
pod that mounts the CSI volume. [Kubernetes](../../../auth/kubernetes.mdx) and
[JWT](../../../auth/jwt/index.mdx) auth methods are supported. The pod's service account
