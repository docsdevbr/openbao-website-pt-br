...
- Prometheus specific instrumentation for [monitoring](telemetry.mdx) the Operator.
- Support for installing using: `Helm` or `Kustomize`<br />
*see the [installation](installation.mdx) docs for more details*

## Supported secret sources

The Vault Secrets Operator supports syncing from multiple secret sources.
Refer to the [secret sources overview](sources/index.mdx) for more details.
