...
- All Vault [secret engines](../../../../secrets/index.mdx) supported.
...
| Backend                                   | Description                                                                                                 |
|-------------------------------------------|-------------------------------------------------------------------------------------------------------------|
| [Kubernetes](../../../../auth/kubernetes.mdx) | Relies on short-lived Kubernetes ServiceAccount tokens for Vault authentication                             |
| [JWT](../../../../auth/jwt/index.mdx)               | Relies on either static JWT tokens or short-lived Kubernetes ServiceAccount tokens for Vault authentication |
| [AppRole](../../../../auth/approle.mdx)       | Relies on static AppRole credentials for Vault authentication                                               |
| [AWS](../../../../auth/aws/index.mdx)               | Relies on AWS credentials for Vault authentication                                                          |
...
Supported secrets engines: [kv-v2](../../../../secrets/kv/kv-v2.mdx), [kv-v1](../../../../secrets/kv/kv-v1.mdx)

##### KV version 1 secret example

The KV secrets engine's `kvv1` mount path is specified under `spec.mount` of `VaultStaticSecret` custom resource. Please consult [KV Secrets Engine - Version 1 - Setup](../../../../secrets/kv/kv-v1.mdx#setup) for configuring KV secrets engine version 1. The following results in a request to `http://127.0.0.1:8200/v1/kvv1/eng/apikey/google` to retrieve the secret.
...
[KV Secrets Engine - Version 2 - Setup](../../../../secrets/kv/kv-v2.mdx#setup)
guide.
...
Supported secrets engines: [pki](../../../../secrets/pki/index.mdx)

The PKI secrets engine's mount path is specified under `spec.mount` of `VaultPKISecret` custom resource. Please consult [PKI Secrets Engine - Setup and Usage](../../../../secrets/pki/setup.mdx) for configuring PKI secrets engine. The following results in a request to `http://127.0.0.1:8200/v1/pki/issue/default` to generate TLS certificates.
...
Supported secrets engines *non-exhaustive*: [databases](../../../../secrets/databases/index.mdx), [aws](../../../../secrets/aws/index.mdx),
[azure](../../../../secrets/azure/index.mdx), [gcp](../../../../secrets/gcp/index.mdx), ...
...
[Database Secrets Engine - Setup](../../../../secrets/databases/index.mdx#setup) guide.
...
configuration options, consult the
[AWS Secrets Engine - Setup](../../../../secrets/aws/index.mdx#setup) guide.
