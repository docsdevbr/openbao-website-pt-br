...
you have already setup [service principal Kubernetes secret](../api-reference.mdx#hcpauthserviceprincipal),
...
[service principal Kubernetes secret](../api-reference.mdx#hcpauthserviceprincipal)
configured.

Refer to the [Kubernetes VSO installation guide](../installation.mdx)
