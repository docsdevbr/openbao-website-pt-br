...
[see the official documentation](../../../auth/kubernetes.mdx#configuration).
...
Agent configuration settings, [see the Agent documentation](../../../agent-and-proxy/agent/template.mdx#openbao-agent-templates).
...
(`cert.key`) generated by [OpenBao's PKI Secrets Engine](../../../secrets/pki/index.mdx).
