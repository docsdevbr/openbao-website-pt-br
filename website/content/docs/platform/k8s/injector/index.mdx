...
[OpenBao Agent Templates](../../../agent-and-proxy/agent/template.mdx).
...
[Agent documentation](../../../agent-and-proxy/agent/template.mdx#renewals-and-updating-secrets).
...
An example of mounting a OpenBao Agent configmap [can be found here](examples.mdx#configmap-example).
