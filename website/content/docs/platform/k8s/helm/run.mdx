...
configuration value](configuration/index.mdx#ui).
...
[initialized](../../../commands/operator/init.mdx). The
initialization generates the credentials necessary to
[unseal](../../../concepts/seal.mdx#why) all the OpenBao
servers.
...
Unseal](../../../configuration/seal/gcpckms.mdx). This enables OpenBao server pods to
...
Unseal](../../../configuration/seal/awskms.mdx). This enables OpenBao server pods to auto
...
[generally upgrading OpenBao](../../../upgrading/index.mdx), except we can use
the Helm chart to update the OpenBao server StatefulSet. It is important to understand
how to [generally upgrade OpenBao](../../../upgrading/index.mdx) before reading this
section.
...
[general architecture](../../../internals/architecture.mdx)
