...
<!-- needs some testing to ensure our new Chart also works on OpenShift -->
:::warning
...
[installation instructions for the Vault CSI provider](../csi/installation.mdx).
...
- [Vault Helm documentation](index.mdx)
- [Vault K8s documentation](../injector/index.mdx)
