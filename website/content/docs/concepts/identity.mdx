...
the [Identity Secrets Engine](../secrets/identity/index.mdx) documentation.
...
For information about Identity Secrets Engine, refer to [Identity Secrets Engine](../secrets/identity/index.mdx).
