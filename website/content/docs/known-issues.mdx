...
This page lists known issues for [OpenBao releases](release-notes/index.mdx) and any
...
use mlock. In 2.0.0 prior to GA, [mlock was removed](rfcs/mlock-removal.mdx)
