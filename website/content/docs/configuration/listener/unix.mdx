...
- `disable_unauthed_rekey_endpoints` `(bool: true)` - Whether to disable requests to the
  ...
  **As of OpenBao v2.5.0, this parameter defaults to true, forbidding any calls
  to the unauthenticated rekey endpoints.**
