...
sidebar_label: GCP Cloud KMS
description: >-
  The GCP Cloud KMS seal configures OpenBao to use GCP Cloud KMS as the seal
  wrapping
...
- The presence of a `seal "gcpckms"` block in OpenBao's configuration file.
...
This example shows configuring GCP Cloud KMS seal through the OpenBao
