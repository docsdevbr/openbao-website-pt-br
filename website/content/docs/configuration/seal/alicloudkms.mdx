...
sidebar_label: AliCloud KMS
description: >-
  The AliCloud KMS seal configures OpenBao to use AliCloud KMS as the seal
  wrapping
...
The AliCloud KMS seal configures OpenBao to use AliCloud KMS as the seal wrapping mechanism.
The AliCloud KMS seal is activated by one of the following:

- The presence of a `seal "alicloudkms"` block in OpenBao's configuration file.
...
This example shows configuring AliCloud KMS seal through the OpenBao configuration file
