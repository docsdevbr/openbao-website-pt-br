...
OpenBao's [plugin
multiplexing](plugin-architecture.mdx#plugin-multiplexing) feature.
...
communication](plugin-architecture.mdx#plugin-communication). If you
...
plugin. Finally,
[register](plugin-architecture.mdx#plugin-registration) the
