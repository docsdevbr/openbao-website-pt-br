...
The [`api_addr`](../configuration/index.mdx#api_addr) must be set in order for the
...
the [configuration file](../configuration/index.mdx).
...
[Upgrading OpenBao Plugins](../upgrading/plugins.mdx).
