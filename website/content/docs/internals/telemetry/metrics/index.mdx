...
description: |-
  Learn about how telemetry metrics are structured in OpenBao
---
...
- **Summary metrics** provide observational values. OpenBao commonly uses
...
| `cluster`              | `openbao-cluster-d54ad07` | Name of the cluster where the metric originated                                                                                              |
...
| `secret_engine`        | `kv`                      | Secrets engine type                                                                                                                          |
