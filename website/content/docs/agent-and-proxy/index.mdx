...
through [AppRole auth method](../auth/approle.mdx#code-example), and then uses
...
[caching]: agent/caching/index.mdx
[apiproxy]: proxy/apiproxy.mdx
[template]: agent/template.mdx
[exec]: agent/process-supervisor.mdx
[openbaoagent]: agent/index.mdx
[openbaoproxy]: proxy/index.mdx
[winsvc]: agent/winsvc.mdx
