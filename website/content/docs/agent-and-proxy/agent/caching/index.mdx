...
API](https://godoc.org/github.com/openbao/openbao/api#Renewer). Agent performs
...
[described in the API Proxy documentation](../apiproxy.mdx#configuration-api_proxy) only to
...
[agent-template]: ../template.mdx
[agent-listener]: ../index.mdx#listener-stanza
