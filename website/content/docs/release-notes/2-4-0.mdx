...
OpenBao v2.4.2 is unreleased due to release pipelines running out of space,
requiring a new tag to be pushed. The release notes are otherwise equivalent
and either tag will fix the relevant issues below.
