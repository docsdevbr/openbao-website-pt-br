...
refer to the [JWT Authentication](index.mdx#jwt-authentication) section below. Basic
...
[OIDC Provider Setup](oidc-providers/index.mdx)
...
- Azure requires some additional configuration when a user is a member of more
  ...
  configuration](oidc-providers/azuread.mdx#optional-azure-specific-configuration)
