...
OpenBao supports Multi-factor Authentication (MFA) for authenticating to an auth
...
TOTP passcodes by default. We recommend that per-client [rate limits](../../concepts/resource-quotas.mdx)
