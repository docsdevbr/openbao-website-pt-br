...
OpenBao-defined _roles_. The open design of `AppRole` enables a varied set of
...
An "AppRole" represents a set of OpenBao policies and login constraints that must
...
final authenticating client by using [Response Wrapping](../concepts/response-wrapping.mdx).
