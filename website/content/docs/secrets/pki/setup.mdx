...
1. Configure a CA certificate and private key. OpenBao can accept an existing key
...
1. Configure a role that maps a name in OpenBao to a procedure for generating a
