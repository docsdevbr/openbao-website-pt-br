...
sidebar_label: Import Key Wrapping Guide
description: |-
...
Google's [tink library](https://pkg.go.dev/github.com/tink-crypto/tink-go/v2/kwp/subtle)
...
Note that though this example uses SHA256, OpenBao also supports the use of
...
This is the ciphertext that should be provided to OpenBao when importing a
