...
* Existing OpenBao [leases](../concepts/lease.mdx) and [tokens](../concepts/tokens.mdx)
...
[plugin_reload_command]: ../commands/plugin/reload.mdx
[plugin_registration]: ../plugins/plugin-architecture.mdx#plugin-registration
[plugin_management]: ../plugins/plugin-management.mdx#enabling-disabling-external-plugins
