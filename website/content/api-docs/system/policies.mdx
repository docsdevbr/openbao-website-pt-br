...
| Method | Path                                 | With Policy Data |
| :----- | :----------------------------------- | :--------------- |
| `LIST` | `/sys/policies/acl`                  | No               |
| `LIST` | `/sys/policies/acl/:prefix`          | No               |
| `LIST` | `/sys/policies/detailed/acl`         | Yes              |
| `LIST` | `/sys/policies/detailed/acl/:prefix` | Yes              |
