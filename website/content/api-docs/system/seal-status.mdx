...
description: The `/sys/seal-status` endpoint is used to check the seal status of an OpenBao.
---
...
This endpoint returns the seal status of the OpenBao. This is an unauthenticated
endpoint.
