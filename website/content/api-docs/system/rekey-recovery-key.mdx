...
endpoints, please see [rotation endpoints](rotate/index.mdx). To re-enable,
see the documentation around the `disable_unauthed_rekey_endpoints` [listener parameter](/docs/configuration/listener/unix/).
