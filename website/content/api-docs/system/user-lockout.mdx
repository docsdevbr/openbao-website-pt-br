...
description: The `/sys/locked-users` endpoint is used to manage locked users in OpenBao.
---

# `/sys/locked-users`

The `/sys/locked-users` endpoint is used to list and unlock locked users in OpenBao.

Refer to the [user lockout](/docs/concepts/user-lockout) overview for more details about how OpenBao handles lockouts.
