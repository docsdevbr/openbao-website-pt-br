...
description: |-
  This is the API documentation for the OpenBao TLS Certificate authentication
  method.
---
...
Certificate method, please see the [OpenBao TLS Certificate method documentation](/docs/auth/cert).

This documentation assumes the TLS Certificate method is mounted at the
`/auth/cert` path in OpenBao. Since it is possible to enable auth methods at any
