...
sidebar_label: AppRole
description: This is the API documentation for the OpenBao AppRole auth method.
---

# AppRole auth method (API)

This is the API documentation for the OpenBao AppRole auth method. For
general information about the usage and operation of the AppRole method, please
see the [OpenBao AppRole method documentation](/docs/auth/approle).
...
Issues an OpenBao token based on the presented credentials. `role_id` is always
