...
description: This is the API documentation for the OpenBao RADIUS auth method.
---

# RADIUS auth method (API)

This is the API documentation for the OpenBao RADIUS auth method. For
general information about the usage and operation of the RADIUS method, please
see the [OpenBao RADIUS method documentation](/docs/auth/radius).
