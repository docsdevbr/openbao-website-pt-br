...
description: |-
  This is the API documentation for the OpenBao username and password
  auth method.
---

# Userpass auth method (HTTP API)

This is the API documentation for the OpenBao Username & Password auth method. For
general information about the usage and operation of the Username and Password method, please
see the [OpenBao Userpass method documentation](/docs/auth/userpass).
