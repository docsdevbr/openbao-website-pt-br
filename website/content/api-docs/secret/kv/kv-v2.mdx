...
description: This is the API documentation for the OpenBao KV secrets engine, version 2.
---

# KV secrets engine - version 2 (API)

This is the API documentation for the OpenBao KV secrets engine while running in
versioned mode. For general information about the usage and operation of the version 2
KV secrets engine, please see the [OpenBao KV documentation](/docs/secrets/kv/kv-v2).
...
the associated [metadata endpoint](kv-v2.mdx#read-secret-metadata).
